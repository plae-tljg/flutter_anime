...
class ClickWaitExtractStrategy implements ExtractionStrategy {
  @override
  ExtractionStrategyType get type => ExtractionStrategyType.clickWaitExtract;
  ...
  Future<String> extract(
    ...
    if (url.isEmpty) {
      throw Exception('Could not find video element after click');
    }
    return url;
  }
